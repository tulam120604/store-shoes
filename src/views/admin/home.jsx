...
const Dashboard = ({ themeBg }) => {
    const wrapperSideBar = (themeBg.Bg_Color) ? '#ECECEC' : '#222626';
    const stroke = (themeBg.Bg_Color) ? 'black' : 'white';
    return (<>
        <div className="dasboard">
            <div>
                <HeaderAdmin
                    bgHeader={{
                        themeHeader: themeBg.switch,
                        Bground: themeBg.Bg_Color
                    }} />
                {/* icon */}
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div style={{ background: wrapperSideBar, stroke: stroke, position: 'fixed' }}
                            className="sidebar border-right col-md-3 col-lg-2 p-0 mt-24 z-10">
                            <div className="offcanvas-md offcanvas-end " tabIndex={-1} id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                                <div className="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                                    <ul className="nav flex-column">
                                        <li className="nav-item pb-2.5">
                                            <a className="nav-link d-flex align-items-center gap-3" aria-current="page" href="#">
                                                <svg className="bi"><use xlinkHref="#house-fill" /></svg>
                                                Dashboard
                                            </a>
                                        </li>
                                        <li className="nav-item py-2.5">
                        ...
                        <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-24">
